...
class GenericEnvMixin(OAuth2Mixin):
    ...
    _OAUTH_AUTHORIZE_URL = "https://oauthasservices-b4230efae.us1.hana.ondemand.com/oauth2/api/v1/authorize?response_type=code&scope=full_access&client_id=cfee7772-3950-345e-9e1a-80927098fa6b"
